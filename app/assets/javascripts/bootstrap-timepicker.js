...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    formatTime: function(hour, minute, second, meridian) {
      ...
      return minute + (this.showSeconds ? ':' + second : '') + (this.showMeridian ? ' ' + meridian : '');
    },
    ...
    getTemplate: function() {
      ...
      case 'modal':
        ...
        break;
      case 'dropdown':
        template = '<div class="bootstrap-timepicker-widget dropdown-menu" style="width:20%">'+ templateContent +'</div>';
        break;
      }
